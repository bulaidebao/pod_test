...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/bulaidebao/pod_test'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'bulaidebao' => 'yangshubao@hualala.com' }
  s.source           = { :git => 'https://github.com/bulaidebao/pod_test.git', :tag => s.version.to_s }
